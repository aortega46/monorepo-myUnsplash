...
export declare class ImageController {
    ...
    remove(id: string): Promise<import("mongoose").ModifyResult<import("mongoose").Document<unknown, {}, import("./entities/image.entity").Image> & import("./entities/image.entity").Image & Required<{
        _id: string;
    }>>>;
}
